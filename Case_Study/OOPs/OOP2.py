...
class student(person):
    ...
    def dispInfo(self):
        x = "Name: {}\nDate-of-Birth: {}\nDepartment: {}\nPRN: {}\nYear: {}\nCGPA: {}".format(self.name, self.dob,
                                                                                              self.dept, self.prn,
                                                                                              self.year, self.cgpa)
        print(x)
...
class faculty(employee):
    ...
    def dispInfo(self):
        x = "Name: {}\nDate-of-Birth: {}\nDepartment: {}\nEmployee ID: {}\nSalary: {}\nSubject: {}\nNumber of research papers: {}\nQualification: {}".format(
            self.name, self.dob, self.dept, self.empID, self.salary, self.subjects, self.researches, self.qualification)
        print(x)
...
if __name__ == "__main__":
    asst1 = lab_asst("Rin", date(1995, 12, 6), "Computer", "e001", 50000, ["b1", "b2"])
    asst2 = lab_asst("Emilia", date(1997, 6, 10), "IT", "e002", 50000, ["b3", "b2"])
    ...
    stud1 = student("Neko", date(2002, 8, 13), "Computer", "2030331245037", 2, 9.62)
    stud2 = student("Pricilla", date(2002, 12, 22), "Computer", "2030331245012", 2, 9.2)
    stud3 = student("Ken", date(2002, 8, 13), "IT", "2030331246031", 2, 8.5)
    stud4 = student("Subaru", date(2002, 8, 13), "Computer", "2030331245020", 2, 7.1)
    stud5 = student("Melodias", date(2002, 8, 13), "IT", "2030331246032", 2, 4.5)
